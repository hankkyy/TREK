...
const admin: TranslationStrings = {
  ...
  'admin.addons.catalog.atlas.name': '地图集',
  ...
  'admin.update.dataInfo': '你的所有数据（旅行、用户、API 密钥、上传文件、假期、地图集、预算）将被保留。',
  ...
  'admin.notifications.inappPanel.title': '应用内',
