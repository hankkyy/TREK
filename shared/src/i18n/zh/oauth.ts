...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.atlas:read.label': '查看地图集',
  'oauth.scope.atlas:read.description': '读取已访问国家、地区和心愿清单',
  'oauth.scope.atlas:write.label': '管理地图集',
  ...
  'oauth.authorize.authorizing': '授权中…',
  'oauth.authorize.loading': '加载中…',
  'oauth.authorize.errorTitle': '授权错误',
  'oauth.authorize.loginTitle': '请登录以继续',
  ...
  'oauth.authorize.requestDescription': '此应用程序正在请求访问你的 TREK 账户。',
  'oauth.authorize.trustNote': '仅授予你信任的应用程序访问权限。你的数据始终保存在你自己的服务器上。',
  'oauth.authorize.selectScope': '请至少选择一个权限范围',
  'oauth.authorize.approveOneScope': '批准（{count} 个权限）',
  'oauth.authorize.approveManyScopes': '批准（{count} 个权限）',
  ...
  'oauth.authorize.alwaysTool.listTrips': '列出你的旅行，以便 AI 发现旅行 ID',
  'oauth.authorize.alwaysTool.getTripSummary': '读取旅行概览，使用其他工具所必需',
};
